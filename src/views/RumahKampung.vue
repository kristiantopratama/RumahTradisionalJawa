    ...
    <body>
        ...
        <section style="height: 245vh;">
            ...
            <div class="content1">
                ...
                <div class="deskripsirumah" v-for="(i,index) in getLabelClassRumahKampung" :key="index">
                    <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        {{i.description.value}}
                    </p>
            ...
            <div class="navigasiImage">                   
                    <div class="content3" v-for="(i,index) in getRumahKampung" :key="index" >
                        <div v-if="i.image">
...
export default {
  ...
  mounted(){
    this.$store.dispatch('getRumahKampung'),
    this.$store.dispatch('getLabelClassRumahKampung')
  ...
  data(){
    return{
      selectComponent: 'getRumahKampung'
    }
  },
