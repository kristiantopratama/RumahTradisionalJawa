    ...
    <body>
        ...
        <section style="height: 215vh;">
            ...
            <div class="content1">
                ...
                <div class="deskripsirumah" v-for="(i,index) in getLabelClassRumahJoglo" :key="index">
                    <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        {{i.description.value}}
                    </p>
...
export default {
  ...
  mounted(){
    this.$store.dispatch('getRumahJoglo'),
    this.$store.dispatch('getLabelClassRumahJoglo')
