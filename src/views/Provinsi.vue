    ...
    <body>
        <nav>
            <div class="navigasi">
                ...
                <div class="navigasi">
                    ...
                    <router-link :to="{name: 'ornamen' }" class="ornamen">
                        Ornamen
                    </router-link>
        ...
        <section style="height:270vh;">
            ...
            <div class="navigasiImage">                   
                <div class="content3" v-for="(i,index) in getRumahFromProvinsi" :key="index" >
                    <div v-if="i.image">
...
export default {
  ...
  mounted(){
    this.$store.dispatch('getRumahFromProvinsi')
  ...
  data(){
    return{
      selectComponent: 'getRumahFromProvinsi'
    }
  },
